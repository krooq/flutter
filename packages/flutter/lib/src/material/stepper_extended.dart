...
class StepperExt extends StatefulWidget {
  ...
  @override
  _StepperStateExt createState() => _StepperStateExt();
}

class _StepperStateExt extends State<StepperExt> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(StepperExt oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    assert(() {
      if (context.ancestorWidgetOfExactType(StepperExt) != null)
        throw FlutterError(
